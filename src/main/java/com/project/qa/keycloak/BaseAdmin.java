package com.project.qa.keycloak;

import com.project.qa.exception.BadRequestException;
import com.project.qa.exception.InternalServerErrorException;
...
public abstract class BaseAdmin {
    ...
    private static final Pattern REALM_URI_PATTERN = Pattern.compile("(http?://.*/auth)/realms/(.*)");
